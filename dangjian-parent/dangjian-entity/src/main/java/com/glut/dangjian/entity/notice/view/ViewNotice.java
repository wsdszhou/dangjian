...
public class ViewNotice  implements Serializable{
    ...
    private String btzdxid;

    private String btzdxmc;

    private String btzdxyhxxid;

    private String btzdxxm;
    ...
    public String getBtzdxid() {
        return btzdxid;
    }

    public void setBtzdxid(String btzdxid) {
        this.btzdxid = btzdxid == null ? null : btzdxid.trim();
    }

    public String getBtzdxmc() {
        return btzdxmc;
    }

    public void setBtzdxmc(String btzdxmc) {
        this.btzdxmc = btzdxmc == null ? null : btzdxmc.trim();
    }

    public String getBtzdxyhxxid() {
        return btzdxyhxxid;
    }

    public void setBtzdxyhxxid(String btzdxyhxxid) {
        this.btzdxyhxxid = btzdxyhxxid == null ? null : btzdxyhxxid.trim();
    }

    public String getBtzdxxm() {
        return btzdxxm;
    }

    public void setBtzdxxm(String btzdxxm) {
        this.btzdxxm = btzdxxm == null ? null : btzdxxm.trim();
    }
